...
- [kuino manifest version in tag](memory/kuino-manifest-version-in-tagged-commit.md) — bump library.json IN the tagged commit
...
- [IoT trust pio ci not clang](memory/iot-trust-pio-ci-not-clang.md) — IDE clang errors are false
